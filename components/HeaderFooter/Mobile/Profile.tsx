...
const Profile_component = () => {
    ...
    const svgcolour = pathname == '/profile' ? '#0000CD' : '#080808'
    const border = pathname == '/profile' ? 'border-t-4 border-blue-800' : '';
    return (

        <div
            style={{ color: svgcolour }}
            className={`active:bg-slate-100 transition-colors duration-200  rounded-sm  ${border}`}>
            <Link
                href="/profile"
                className='flex flex-col items-center justify-center'
            >
                <svg width="50px" height="25px" viewBox="0 0 22 22" fill="none" >
